...
export default {
	namespace: 'ordermanage',// model对应的命名空间，其他比如router容器组件中获取state的时需要带上命名空间
	...
	effects: {//异步操作，使用redux-sagas做异步流程控制，采用的generator 同步写法
		*query ({payload}, {call, put}){
			...
			const data = yield call(getDataService, { url:api.getOrdList }, {...payload, serviceId: 'srvid_getOrdList'})
			if(data){
